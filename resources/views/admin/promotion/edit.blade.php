                            ...
                            <div id="main-content">
                            	<div class="span6 widget">
										<div class="widget-header">
											<span class="title">Редактировать</span>
										</div>
										<div class="widget-content form-container">
											<form id="validate-1" class="vertical-form" method="post" action="{{ route('admin.promotion.update', $price) }}">
                                                {{ csrf_field() }}
												<div class="control-group @if($errors->first('name'))error @endif">
													...
													<div class="controls">
														<input type="text" name="name" class="span4" value="{{ old('name', $price->name) }}">
												...
												<div class="control-group @if($errors->first('price'))error @endif">
													...
													<div class="controls">
														<input type="text" name="price" class="span4" value="{{ intval(old('price', $price->price)) }}">
                                                        @if($errors->first('name'))
                                                ...
                                                <div class="control-group @if($errors->first('min_count'))error @endif">
													...
													<div class="controls">
														<input type="text" name="min_count" class="span4"  value="{{ old('min_count', $price->min_count) }}">
                                                ...
                                                <div class="control-group @if($errors->first('max_count'))error @endif">
													...
													<div class="controls">
														<input type="text" name="max_count" class="span4" value="{{ old('max_count', $price->max_count) }}">
